 ...
 */
define ('PDF_HEADER_LOGO', '3dtech.png');
 ...
 * Document creator.
 */
define ('PDF_CREATOR', 'Obaja');

/**
 * Document author.
 */
define ('PDF_AUTHOR', 'Obaja');

/**
 * Header title.
 */
define ('PDF_HEADER_TITLE', 'Job Completion Report');

/**
 * Header description string.
 */
define ('PDF_HEADER_STRING', "by PT.3D TECH - New Dimension Technology\nwww.3dtech.net.id");
